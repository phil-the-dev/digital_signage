    ...
    def create
      ...
      respond_to do |format|
        if @playlist_playable.save
          format.html { redirect_to [:admin, @playlist_playable], notice: 'Playlist playable was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @playlist_playable.update(playlist_playable_params)
          format.html { redirect_to [:admin, @playlist_playable], notice: 'Playlist playable was successfully updated.' }
